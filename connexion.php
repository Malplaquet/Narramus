...
$req=$bdd->prepare('SELECT id, pseudo, pass FROM members WHERE pseudo = :pseudo');
$req->execute(array(
  'pseudo' => $_POST['pseudo']));
$resultat = $req->fetch();
...
$req->closeCursor();
  ...
  <div class="corps">
    <div class="bloc_texte">
      <div class="container">
        <form class="form_deconnexion" action="deconnexion.php" method="post">
          <button class="button_deconnexion" type="submit" name="button">Deconnexion</button>
        </form>
