...
Vous pouvez dès à present vous connecter sur le site afin de pouvoir échanger avec la communauté de nos lecteur.
...
Votre équipe de rédacteur administrateur.";
  ...
  $twig_vars['error']['MailMissing'] = '<div class="col-12 div_error_create_account">Vous n\'avez pas renseigné d\'adresse mail.</div>';
}
else {
  $twig_vars['error']['errorMissInput'] = '<div class="col-12 div_error_create_account">Un champ du formulaire n\'a pas été rempli.</div>';
}
